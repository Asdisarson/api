            ...
            for (var k = 0; k < response.body.length; k++) {
                ...
                for (var i = 0; i < response.body[k].rooms.length; i++) {
                    var room = {
                        ...
                        averageDailyPrice: response.body[k].rooms[i].averageDailyPrice.toLocaleString("da-DK"),
                        price: response.body[k].rooms[i].price.toLocaleString("da-DK"),
                        ...
                        totalBreakfastPrice: response.body[k].rooms[i].totalBreakfastPrice.toLocaleString("da-DK"),
                        totalOriginalBreakfastPrice: response.body[k].rooms[i].totalOriginalBreakfastPrice,
                        extraBedPrice: response.body[k].rooms[i].extraBedPrice.toLocaleString("da-DK"),
