                        ...
                        for (var i = 0; i < response.data[k].rooms.length; i++) {
                            ...
                            if (room.price !== null) {
                                room['booking'] = "?add-to-cart=1209&propertyId=" + response.data[k].rooms[i].propertyId +
                                    ...
                                    startDate + "&endDate=" + data.endDate + "&numberOfPeople=" + req.query.numberOfPeople + "&roomname=" + response.data[k].name + "&hotelname=" + response.data[k].rooms[i].name
                                    + "&quantity=1"
                            ...
                            if (response.data[k].rooms[i].available === true) {
